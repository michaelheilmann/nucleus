...
macro(define_test module_name project_name libraries language)
  if (${language} EQUAL ${NUCLEUS_LANGUAGE_ID_C})
    project (${project_name} C)
	message("building C ${PROJECT_NAME}")
  elseif (${language} EQUAL ${NUCLEUS_LANGUAGE_ID_CPP})
  ...
  if (NOT DEFINED ${project_name}-With-Debug-Information)
    set(${project_name}-With-Debug-Information ${${module_name}-With-Debug-Information})
  endif()

  if (NOT DEFINED ${project_name}-With-Optimizations)
    set(${project_name}-With-Optimizations ${${module_name}-With-Optimizations})
  endif()
  ...
  set_project_default_properties(${module_name} ${PROJECT_NAME})
